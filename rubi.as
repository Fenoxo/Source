...
function approachRubiScenes():void {
	...
	//(Approach repeat, relationship 20+.  At this stage, randomly select an outfit from what the PC has given him, plus his waitress outfit.  Variants included for Bimbo /Incubus Rubi.)
		...
		//(Suit Clothes (Normal))
			...
			else if(flags[RUBI_COCK_SIZE] > 0) outputText("Luckily, given " + rubiMF("his","her") + " relatively small package, " + rubiMF("his","her") + " bulge is kept nice and secret even with the tightness of the clothing.");
		}
		else if(select == 9) {
			//(Nurse Clothes (Bimbo))
