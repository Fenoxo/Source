...
function cathedralC():void {
	clearOutput();
	outputText("As you sit down with " + flags[GAR_NAME] + " to talk, you remember her words when you first met indicating that she could not – or would not – leave the Cathedral, even if you asked her to.   You ask her about that.");
	outputText("\n\n\"<i>Master,</i>\" " + flags[GAR_NAME] + " says, now looking you straight in the eye, \"<i>the Cathedral is my home, the only home I've ever known.  Even if I could leave, I would not want to");
...
function comfortGargoyle():void {
	...
	outputText("\n\nTo your surprise, " + flags[GAR_NAME] + " follows you, running to catch up with you.  She takes your hand in hers and wraps one of her wings around you as you walk, holding you close as you make your way out the doors and onto the grounds.  Soon, though, you see " + flags[GAR_NAME] + " slowing and grimacing – approaching the edge of her boundary.  The two of you stop at the wrought-iron fence surrounding the Cathedral, and face each other.");
...
function talkAboutGarName():void {
	if(flags[GAR_NAME_TALKS] == 0) {
		flags[GAR_NAME_TALKS] = 1;
		garNameA();
	}
	else if(flags[GAR_NAME_TALKS] == 1) {
		flags[GAR_NAME_TALKS] = 2;
		garNameB();
	}
	else {
		flags[GAR_NAME_TALKS] = 3;
		garNameC();
	}
}


//[b]" + flags[GAR_NAME] + " A[/b]
//(Confidence +3)
function garNameA():void {
	clearOutput();
	outputText("Curious about your gargoyle, you ask " + flags[GAR_NAME] + " to tell you a little bit about her life before you arrived.  She makes a nervous chuckle at the request, and shyly says, \"<i>Master is too kind...  I am no one special...</i>\"");
	...
	else outputText("After what she did to me, I never thought I'd enjoy sex again.</i>\"  With a loving smile, " + flags[GAR_NAME] + " takes your hand in hers and brushes it against her cheek.  \"<i>But for you, Master, I think I could make an exception.</i>\"");
...
function garNameB():void {
	...
	outputText("\n\nYou don't need to prompt " + flags[GAR_NAME] + " this time.  \"<i>She left, perhaps ten years ago.  One day I was following orders to Master's pleasure, and the next I was bound to my pedestal, wearing the chains that Master broke to set me free.</i>\"");
...
function comfortGarNameC():void {
	clearOutput();
	outputText("You pull " + flags[GAR_NAME] + " onto your lap and run your hand through her hair.  You tell her that she's wrong – dead wrong.  She is a person, and she is not helpless.  She's anything but.");
	...
	outputText("\n\nShe smiles weakly, and rests her head on your chest.  \"<i>As you command, Master,</i>\" she says, and falls silent.  You sit there for a long while, stroking the gargoyle's soft hair and hoping you have made an impression on her.  But, eventually, you know you have to part.  You give " + flags[GAR_NAME] + " a little kiss on the forehead and tell her to do whatever she wants while you're gone.");
	...
	outputText("\n\nSighing, you pat " + flags[GAR_NAME] + " on the head and tell her you'd be happy to stay for a while longer.  Beaming, she asks you what you'd like to do.");
...
function gargoyleAppearance():void {
	clearOutput();
	outputText("" + flags[GAR_NAME] + " is a gray marble statue that, through magics you can't quite grasp, has been animated.");
