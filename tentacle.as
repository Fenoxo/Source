...
function tentacleLossRape():void {
	...
	if(player.gender == 3) 
	{
		...
		outputText(" As " + num2Text((player.totalNipples())) + " thorny tentacles pierce your nipples, you feel as if someone shot acid into your tits, which immediately begin to swell.", false);
