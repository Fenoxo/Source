...
function brookeSpecialMediumSceneContinued():void {
	...
	//{Herms only}
		...
		//[if (hasBalls = true)
		if(player.balls > 0) {
			if(player.hasStatusAffect("Uniball") < 0) outputText("  Your [sack] swings with every pump, slapping onto the firm skin of Brooke's vulva every time you bottom out.  You feel no pain, and in fact the smoothness of her fur around her genitals tickles the cum out of your [balls] all the faster.");
			else outputText("  Your [sack] is to tight and smooth to swing, but it still slaps against the firm skin of Brooke's vulva every time you bottom out.  The smoothness of her fur around her genitals tickles the cum out of your [balls] all the faster.");
		}
