...
//Arriving at Camp
function arriveWithLacticWaifuAtCamp():void {
	clearOutput();
...
function nameZeMilkBath():void {
	...
	//Having Named the Girl (Didn't name her Bath Slut)
		...
		outputText("You crouch down beside the newly-named girl, brushing a few stray strands of her dark hair from her cheeks.  \"<i>No more Bath Slut.  You're " + flags[MILK_NAME] + " now.  " + flags[MILK_NAME] + "'s your name.</i>\"");
	
		outputText("\n\n\"<i>" + flags[MILK_NAME] + "</i>\" she hesitantly repeats.  Looks like she gets it!  \"<i>" + flags[MILK_NAME] + "!</i>\" she says, more confidently as you encourage her.");
	}
	//Arrival: Part 2 (PC has Rath in camp)
	if(player.hasStatusAffect("Camp Rathazul") >= 0 && player.statusAffectv2("metRathazul") >= 4) {
		outputText("\n\nAs you finish deciding on what to call " + flags[MILK_NAME] + ", you hear footsteps shuffling over to the two of you.  Looking up, you see the old rat alchemist Rathazul approaching, nose buried in an ancient-looking tome.  \"<i>Good news, [name]!</i>\" he calls, just before tripping over the prone milkmaid, going sprawling across the ground.");
		
		outputText("\n\n\"<i>Gah!  Help, I can't get up!</i>\" he shouts, flailing around until you rush over and pull him to his feet.");
		
		outputText("\n\n\"<i>Ah, thank you, youngling.  But...  egad, [name], what have you dragged in this time?</i>\" he mumbles, fishing a pair of spectacles out of his pocket to examine " + flags[MILK_NAME] + ".  \"<i>Why, it's a girl...  a very, um, busty girl at that.  Gods be good, how the devil does she stand with all that...  those...  those things on her chest?</i>\"");
		
		outputText("\n\n\"<i>Milk time?</i>\" " + flags[MILK_NAME] + " mewls, reaching back to rub her full, round ass where Rath bumped into her.  Sheepishly, you explain that she doesn't stand, per se.  You're not sure what the Sand Witches did to her, but she's not quite capable of taking care of herself.");
		
		outputText("\n\n\"<i>I see.  Poor dear,</i>\" Rath says, shakily kneeling down beside " + flags[MILK_NAME] + ".  He brushes her cheek sympathetically, a sorrowful smile playing across his aged features.  \"<i>She's hardly the first to be changed so drastically by these awful times, my friend.  Aside from counseling and lessons, I do not know what I can do to help a mind that's been subjected to the horrors this girl has doubtless seen, but at the very least, my Reducto concoction may be able to help her live with some semblance of normality.</i>\"");
		...
		outputText("\n\nWith that, Rath hobbles off back to his little laboratory, leaving you with " + flags[MILK_NAME] + ".");
...
function ratducto():void {
	...
	outputText("\n\n\"<i>I see.  Poor dear,</i>\" Rath says, shakily kneeling down beside " + flags[MILK_NAME] + ".  He brushes her cheek sympathetically, a sorrowful smile playing across her aged features.  \"<i>She's hardly the first to be changed so drastically by these awful times, my friend.  Aside from counseling and lessons, I do not know what I can do to help a mind that's been subjected to the horrors this girl has doubtless seen, but at the very least, my Reducto concoction may be able to help her live with some semblance of normality.</i>\"");
...
function milkyMenu():void {
	clearOutput();
	outputText("You wander over to " + flags[MILK_NAME] + "'s pool, and find the dusky girl sitting at its rim, ");
	if(flags[MILK_SIZE] == 0) outputText("lying face-down on her massive rack, her plump little ass sticking up in the air for all to see.  Seeing you approach, she brightens up and shifts her titanic bust around to face you, all bright-eyes and smiles.  \"<i>Milk time?</i>\"");
	else if(flags[MILK_SIZE] == 1) outputText("arms crossed under her hefty, milky bust to support their still-sizable weight.  She smiles as you approach, able to stand up under her own power to give you a hug, milky tits pressed tight against you.  \"<i>I-is it milk time?</i>\" she asks, cupping her tits for you.");
	...
	if(flags[MILK_SIZE] > 0) addButton(1,"Milk Time!",nyanCatMilkTime);
	if(flags[MILK_SIZE] < 2) addButton(2,"Milk Bath",milkBathTime);
	if(flags[MILK_SIZE] < 2 && player.hasKeyItem("Super Reducto") >= 0) addButton(3,"Reducto",superReductoUsage);
	if(flags[MILK_SIZE] > 0 && player.lust >= 33 && player.hasCock()) addButton(5,"Titfuck",titFuckDatMilkSlut);
...
function milkWriteFuAppearance():void {
	clearOutput();
	outputText("" + flags[MILK_NAME] + " is a five-foot-five human female, with darkly tanned skin and ebony hair.  ");
	if(flags[MILK_SIZE] >= 2) outputText("Over her supple body, she wears a simple cloth shift which cuts off just above her knees, hiding her newly-gained modesty, with a pair of silk painties and a simple bra beneath it.  ");
	...
	//{If GIANT boobs: 
	if(flags[MILK_SIZE] == 0) outputText("\n\nHer most distinguishing feature, though, is her massive bust.  Enough to drag her down onto all fours without support, " + flags[MILK_NAME] + "'s rack is absolutely gigantic.  Her areola are the size of plates, constantly dribbling motherly fluids with every breath she takes.  The slightest touch is enough to get a stream flowing from " + flags[MILK_NAME] + "'s titanic teats, enough to fill her entire pool with more to spare.  Those can't be too comfortable, you reckon, even if they are almost mesmerizing in their beauty and potential for sexual pleasure.");
	else if(flags[MILK_SIZE] == 1) outputText("\n\nThough you've reduced them <i>considerably</i>, " + flags[MILK_NAME] + "'s most eye-catching feature is still her tremendous bosom.  Those huge tits of hers would look more normal on a cowgirl than a human girl, and a rather petite one at that.  Her areola are palm-sized and tipped with a pair of prominent nipples, always eager to release their motherly fluids.  She can easily fill a tub with those things, and she alone could provide enough to feed a small village, producing more than the all the cows of Ingnam combined every day.");
	else {
		outputText("\n\nThanks to your intervention, " + flags[MILK_NAME] + "'s breasts aren't so cripplingly large.  Reduced to a DD-cup, you've even managed to scrape together some clothes that actually fit her.  In her current state, you might even call her bust perky, her milk-laden breasts both firm and yet so delightfully soft; you can easily sink your fingers into them, or bury your face");
		if(player.hasCock()) outputText(" or cock");
		outputText(" between her pillowy bosoms.  Despite the reduction in size, " + flags[MILK_NAME] + " is happy to tell you that she's still got plenty of milk inside her, though perhaps not quite as much as before: she can't quite fill the pool all by herself, but now even short milkings leave her blissfully empty for hours afterwards.  She's not an entire farm unto herself now and she seems fairly pleased by this, all things considered.");
	}
...
function superReductoUsage():void {
	clearOutput();
	outputText("You tell " + flags[MILK_NAME] + " that it's about time she got rid of those massive tits of hers.  She cocks her head to the side, looking at you without comprehension.  You fish the giant vial of Reducto Rath gave you from your pack and hold it up for her to examine.  She hesitantly takes it from your hand and rolls it around, sniffing at the foul-smelling stuff.  She turns up her nose at it.");
	...
	if(flags[MILK_SIZE] == 0) {
		...
		outputText("\n\nYou shift " + flags[MILK_NAME] + " around in your lap, giving yourself the best angle on her giant tits.  That done, you lather up with Reducto, covering your hands with the stuff before reaching around and grabbing your friend's tits, smearing the first dollops around her leaky nipples.  She winces, shivering as the cool substance smears onto her teats, but almost immediately you can see it going to work: her breasts shudder, flesh quivering as they begin to shrink like balloons.");
		outputText("\n\n\"<i>[name]!</i>\" " + flags[MILK_NAME] + " cries out, whimpering and moaning as you massage her tits, rubbing a goodly amount of reducto all around her bust.  Milk pours out of her like a pair of hoses, spraying her motherly fluids everywhere as her carrying capacity shrinks and shrinks.  Down and down she goes, breasts shrinking and leaking until they're about HHH-cups - big enough for a cowgirl, but a lot smaller than they were.");
		outputText("\n\n\"<i>That's enough,</i>\" you say, leaning around to put your hands into the spray of milk " + flags[MILK_NAME] + "'s making, washing the reducto from your hands.  When you're done, you wipe her teats off with spare milk, rubbing off the reducto until her dusky skin is as bare as can be, nice and shiny.");
		outputText("\n\nExperimentally, " + flags[MILK_NAME] + " tries to stand.  She nearly falls forward, leaden down by her still-prodigious bosoms, but you catch her, steadying the lightened girl until she's standing on her own power, swaying slightly, but standing.");
		
		outputText("\n\n\"<i>I...  I can...</i>\" she groans, suddenly clutching her head.  You jump up, steadying her again as " + flags[MILK_NAME] + " moans in pain, tugging at her dark hair until suddenly, she's silent.  A long moment passes before she turns to you, all smiles.  \"<i>I can...  walk,</i>\" she says, struggling to form the words.  Before you can react, " + flags[MILK_NAME] + " grabs you, hugging you into her hefty bosom as hard as she can, nearly crying with joy.  Laughing, you hug her back, holding her milk-soaked body tight until she's ready to stand.  Giving you a long, loving kiss, the girl stumbles off, trying to get her land legs back after being on all fours for so long.");
	}
	else {
		outputText("\n\n" + flags[MILK_NAME] + "'s got cowgirl-sized tits right now");
		if(isabellaFollower()) {
			outputText(", enough to give Isabella");
			if(player.hasStatusAffect("Camp Marble") >= 0) outputText(" and Marble");
			outputText(" pause");
		}
		else if(player.hasStatusAffect("Camp Marble") >= 0) outputText(", enough to give Marble pause");
		...
		outputText("\n\n\"<i>[name]!</i>\" " + flags[MILK_NAME] + " cries out, whimpering and moaning as you massage her tits, rubbing a goodly amount of reducto all around her bust.  Milk pours out of her like a pair of hoses, spraying her motherly fluids everywhere as her carrying capacity shrinks and shrinks.  Down and down she goes, breasts shrinking and leaking more and more.  You smear more Reducto on her, using every last drop you've got to help the poor milky slave girl.  She cries out again as her bust seems to explode with milk, a white tidal wave pouring from her shrinking nipples, nearly blinding you.");
		
		outputText("\n\nBy the time you can see again, you and " + flags[MILK_NAME] + " are whiter than snow, completely covered in milk.  You look down, and see that your hands are cupping a beautiful, firm pair of DD breasts.  She's stopped shrinking right where you predicted, leaving her with a shapely bust that any girl could be proud of.  And more importantly, one that she could easily move around with.  Wiping the milk from your eyes, you stroke " + flags[MILK_NAME] + "'s hair, gently urging her to try and stand.  Shakily, she allows herself to be stood up, and you let her go.");
		
		outputText("\n\n" + flags[MILK_NAME] + " nearly falls, but catches herself at the last moment, waving her arms like a bird's to steady herself as she adjusts to her new center of gravity.  She takes a few experimental steps, and finds herself relatively unburdened.  Smiling from ear to ear, the girl turns to you and shouts out, \"<i>I...  I can WALK!</i>\" before leaping into your arms, crying tears of joy as she holds you tight against herself, perky tits dribbling milk onto your chest.  It seems no matter how flat she gets, " + flags[MILK_NAME] + " can't stop producing milk; but now she doesn't have those massive tits to deal with, and for now, that's enough.  The poor slave girl nuzzles her cheek into your neck, shivering as she sobs, fingers clutching at your [armor].");
		
		outputText("\n\nYou let her cry it out for a good long while, stroking her hair and whispering soothing words until finally, she steps back, drying her eyes.  " + flags[MILK_NAME] + " rubs her temples, groaning with a brief moment of pain before looking up at you with bright brown eyes and whispering, \"<i>Thank you...  so very much, [name].</i>\"");
...
function milkBathTime():void {
	...
	outputText("\n\n" + flags[MILK_NAME] + " pulls back, licking her puffy lips and smelling strongly of female arousal, though obviously satisfied.  She whimpers, \"<i>I love bath time,</i>\" before ");
	if(flags[MILK_SIZE] == 0) outputText("starting to shift her breasts' bulk toward a comfortable spot for a nap");
...
function pullInZeMilkGirl():void {
	clearOutput();
	outputText("You call out to " + flags[MILK_NAME] + " before she can wander away, and wade over to the side of the tub, leaving your face a few scant inches from her hefty milkers.  She smiles as you reach up, nuzzling her cheek into your hand, purring your name happily.");
	
	outputText("\n\nYou flash her a mischievous grin before grabbing her waist and pulling, yanking her into the tub with you.  The milk-maid lets out a sharp cry of surprise as she tumbles in, a huge splash of cream spraying over the rim of the tub, painting the campground white.  Gasping, her head pops back over the surface of her own milk, long ebony hair dripping onto the tops of her seemingly-buoyant teats, which bob over the milky waves with a strangely serene, regal grace.   \"<i>[name]?</i>\" " + flags[MILK_NAME] + " yelps as she wades through her own lactation, slowly retreating to the edge of the tub.  Chuckling, you reach out and stroke her cheek, telling her that you thought she might like a bath, too.  She starts to reply, but you cut her off with a playful stroke of her massive mounds, urging her over toward you.  She trusts you implicitly and does as you ask, sliding up under your arm and onto your lap.  Once seated, she looks ups to you with saucer-like brown eyes until you cup her cheek and give her a short, tender kiss, pressing your lips to her dusky mounds.  To your delight, she seems to melt at your touch, relaxing in an instant as you hold her as close as you can, seperated only by her prodigious chest");
	...
	outputText(".  Before you can get too far, though, " + flags[MILK_NAME] + " turns on a heel, her huge rack pushing you back through the milky pool and then against the opposite rim.  You're dazed for only a brief second before her breasts press firmly into your back, so hard that a new streak of milk pours from her teats, wetting your back much as you did hers.  You relax against the rim as she cups up handfuls of milk, rubbing it into your own hair and shoulders, deft fingers massaging every muscle in your back with the skill of the greatest masseuses, and you can feel the tension and bleeding from your muscles.  You yawn powerfully, resting your chin on your arms and letting the milky girl massage you, coating your " + player.skinFurScales() + " in her rich, delicious milk.");
...
function fuckTheMilkWaifu():void {
	...
	outputText("\n\nSubmerged beneath a sea of creamy milk, it's so very, very easy to slide into " + flags[MILK_NAME] + ", ");
...
function drinkAndFapturbate():void {
	clearOutput();
	outputText("\"<i>Wait,</i>\" you call out to the ebony woman, letting the milk obscure your hands as you begin to masturbate, \"I want a drink.</i>\"  Sheepishly, " + flags[MILK_NAME] + " obligingly shifts back toward you, presenting her huge teats.");
	...
	if(flags[MILK_SIZE] == 0) outputText("a dinner plate");
	...
	outputText("\n\nAn excited moan worms out of " + flags[MILK_NAME] + "'s puffy lips, a testament to the raw sensitivity of her milk-bloated jugs.  As your tongue swirls over the leaky nozzle's pebbly skin, she releases another breathy pant of delight.  The vocal tremors seem to coo all the way down to your loins, joining with your fingers' caresses to stir you to aching, trembling arousal.  ");
	//{Fork, no new PG}
	//(DA HERMS)
	if(player.gender == 3) {
	...
	if(flags[MILK_SIZE] == 0) outputText("drags her gigantic tits over the puddly, milk-slicked floor");
...
function nyanCatMilkTime():void {
	...
	if(flags[MILK_SIZE] == 1)
	{
		outputText("\"<i>Milk time!</i>\" you say, giving " + flags[MILK_NAME] + " a playful swat on her upturned ass, walking around her to the pool.  You jump in and toss your [armor] back out as the milky witch gets situated, well aware of just how much milk this poor girl's about to blast you with, even with her much reduced bosom.  Still, she's gotta be milked, and you're thirsty.  Milk time indeed.");
		
		outputText("\n\nOnce you've disrobed, and " + flags[MILK_NAME] + "'s got her giant jugs situated at the edge of the pool, you get to work.  Rubbing your hands together, you place each overtop one of her palm-sized areola, gently running your fingers around the bases of her teat-like nipples, though with every motion your hands seem to be engorged into the massive mounds, sucked into a blackhole of titflesh.  With every touch, though, " + flags[MILK_NAME] + " shudders and moans, biting her lower lip as her arms quiver with pleasure.");
		
		outputText("\n\nIn a matter of moments, you coax out the first explosive spurt of milk from your friend's teats, two hot streams of white cream blasting you in the face and drenching you before you can blink.  \"<i>S-sorryyyyyyyy,</i>\" she whines, voice turning into an ecstatic moan as you grip her nipples and start working vigorously, not letting the milky stream die down for an instant.  " + flags[MILK_NAME] + " moans and groans as you roughly milk her, rewarded with gallon after gallon of delightful motherly milk.");
		
		//If PC has Smart/Normal Sophie:
		if(sophieFollower()) outputText("\n\nAs you milk " + flags[MILK_NAME] + ", you see a shadow flash overhead.  You look up in time to see your harpy broodmother perches at the rim of the pool, just beside " + flags[MILK_NAME] + "'s quivering body.  \"<i>Fresh milk!</i>\" Sophie laughs, cupping up a handful and bringing it to her mouth.  \"<i>You don't mind if Momma Sophie has a taste, do you honey?</i>\"\n\nThe milky girl shakes her head, barely paying attention as Sophie flops down beside her, avian tongue lapping at the stream pouring down into the pool.");
		...
		if(isabellaFollower()) {
			...
			if(isabellaAccent()) outputText("zing");
			else outputText("thing");
			outputText(".  Let Isabella show you how ");
			if(isabellaAccent()) outputText("es ist");
			else outputText("it's");
			outputText(" done.</i>\"  You find yourself roughly pushed aside as Isabella jumps in with you, tossing her skirt and blouse aside as she grasps " + flags[MILK_NAME] + "'s teats, massaging them much more gently.  The milk girl's eyes roll back in her head as Isabella sets to work, though it gets harder and harder as the milk flows up to her thighs and chest.");
		}
		
		//If PC has ONLY KIha or if PC dun have Izzy, Sophie, OR Kiha: 
		if(!isabellaFollower() || !sophieFollower()) outputText("\n\nIt takes a good long while to get " + flags[MILK_NAME] + "'s bloated tits under control, but nearly an hour later you've milked her as well as you can for now.  Sopping wet, you pull yourself out of the pool and grab a towel.  With her tits lightened for the moment, " + flags[MILK_NAME] + " reaches up and pulls you down to her, just long enough to plant a kiss on your cheek and whisper, \"<i>Thank you, [name].  That felt good.</i>\"");
		
		//If PC has Sophie or Isabella:
		else outputText("\n\nThough you didn't intend for this to turn communal, " + flags[MILK_NAME] + " certainly has more than enough to share.  You relax as the last trickles of milk pour into the pool, her breasts looking positively deflated.  You decide to leave the plug in for your friends as you clamber out, figuring they'll want to stockpile a little for the day before you drain it.  With her tits lightened for the moment, " + flags[MILK_NAME] + " reaches up and pulls you down to her, just long enough to plant a kiss on your cheek and whisper, \"<i>Thank you, [name].  That felt good.</i>\"");
		fatigue(-50);
		stats(0,0,0,0,0,0,10+player.sens/10,0,false);
		doNext(13);
	}
	//Milk Time!  (DD Boobs Ver.)
		...
		outputText("You sit yourself down with " + flags[MILK_NAME] + " and ask if she'd like a good milking.  Her eyes brighten at the suggestion, and she whispers \"<i>Yes please,</i>\" already pulling off her shift.  You help her get her top and bra off, leaving her full, perky breasts bare in the cool sun.  You slip behind her, running your hands across her sun-kissed skin, tracing your fingers from hips to chest; " + flags[MILK_NAME] + " shivers are your slightest touch, whining lustily as your hands wrap around her milk-laden mounds.  Her reddened nipples are rock-hard by the time your fingers brush up against them, perspiring clear pearlescent drops as you circle her wide areola.");
		outputText("\n\n" + flags[MILK_NAME] + " whimpers as you squeeze a tiny trickle from her teats, the white fluid squirting out in a powerful arc, staining the campground for the briefest moment before the hungry earth swallows it up, leaving no trace but a darkened patch at the girl's knees.  Gently, you start to squeeze and knead " + flags[MILK_NAME] + "'s breasts, holding her back against you as you massage the heavy burden from her seemingly unending reserves.  A steady stream of milk pours from her chest, dribbling down between your fingers and her flat belly.  Soon a pool's formed around your [legs], the barren earth not nearly fast enough to consume the bounty flowing from your friend.");
		
		outputText("\n\nWith each caress and squeeze, " + flags[MILK_NAME] + " shivers and shakes, her chest soon heaving with her ragged, pleasure-strained breath.  You can see her lustful secretions stain her paintes as her hidden cunt quivers, desperate for attention as you milk her over-sensitive mammaries.  Her breathing becomes more irregular, her long legs quaking and eyes rolling back as you squeeze out gallon after gallon.  Her whimpers of pleasure become outright cries, piercing the quiet of camp with orgasmic moans and shrill screams as your fingers work their magic on her, sending shockwaves of pleasure from hefty teats to sex-addled mind  that make her entire body convulse and writhe at your touch.");
		
		outputText("\n\n\"<i>N-no more.  Can't...  take it...  please.  Ahhhhh,</i>\" " + flags[MILK_NAME] + " cries, squirming in your embrace, your hands firmly locked on her tits, milking her for every drop.  She's in for a mighty boobgasm in mere moments: you could soothe her through it with a gentle suckle or finish her off normally.");
...
function finishMilkNormall():void {
	clearOutput();
	outputText("You whisper a few soothing words into " + flags[MILK_NAME] + "'s ear, but are unrelenting in your task.  With squeezing and kneading fingers, you continue to coax the milk from her tits until she's practically white with flowing cream.  A few minutes later though, you can physically feel her explode over the edge of bliss: the stream of milk from her stiff nipples doubles, blasting an arc several feet long as her voice breaks, a shrill cry to the heavens; " + flags[MILK_NAME] + "'s entire body shudders, her legs nearly giving out as the boobgasm rocks her slender frame.");
	
	outputText("\n\nAs soon as the explosive boobgasm subsides, she collapses back against you, chest heaving with pleasured exhaustion.  The milky stream trickles down to naught, her breasts momentarily depleted.  " + flags[MILK_NAME] + " looks up at you and smiles ever so slightly, caressing your cheek before cupping her obviously-sore teats and staggering to her feet, searching for a towel.");
...
function suckleDatMilk():void {
	...
	outputText("\n\nEventually, the boobgasm subsides, leaving " + flags[MILK_NAME] + " a quivering, panting pile of lust in your arms, her fingers absently rubbing through her panties as the last dribbles of milk trickle down her chest and your chin.  Taking the first deep breath you've managed to get in the last few minutes, you grab a towel from nearby and try to dry yourself and the leaky girl off as best you can, brushing off the gallons of milk that have washed over you both.  When you're done, " + flags[MILK_NAME] + " leans over and plants a long, lusty kiss on your lips, her tongue lapping up little drops of her own milk still inside your mouth.  She breaks the kiss after a long, pleasant moment, whispering \"<i>Thank you, [name].</i>\"");
	fatigue(-50);
	stats(0,0,0,0,0,0,10+player.sens/10,0,false);
	doNext(13);
}
...
function fuckDatMilkSlat():void {
	...
	outputText("Sitting behind the milky girl, chest pressed to her back tight enough to feel her every breath, you can't help but feel " + flags[MILK_NAME] + "s full, round ass brushing against your " + cockDescript(x) + ".  Responding to her touch, your prick begins to stiffen, filling out through your [armor] and into the valley of " + flags[MILK_NAME] + "'s ass.  She gasps ever so slightly when she feels your prick pushing against her silky undergarments, but you can feel her heart race, flesh heaten as she starts to move her ass more deliberately, rubbing you from stem to head.");
	
	outputText("\n\nOne of your hands drifts down from " + flags[MILK_NAME] + "'s teats, fingers tracing along her supple skin and ample curves to the hem of her panties.  You pull them down with one smooth motion, bareing the full mounds of her dusky ass cheeks.  She pushes back immediately, humping up and down your rod as you work to free yourself from your [armor].  Finally, your " + cockDescript(x) + " pops free from its binds, only to be instantly buried in " + flags[MILK_NAME] + "'s rear cleavage; she gives a happy, girlish giggle when your throbbing rod pushes through her valley, practically bouncing on your cock.  You wrap your arms around her waist, one hand working her still-needy teats as the other dives between her legs, easily slipping a few fingers into her sodden gash.  " + flags[MILK_NAME] + " moans lustily as your digits enter her, biting her lower lip when your fingertips caress her inner walls and spasming muscles, soon soaked in her feminine fluids.  Your thumb swirls around the bud of her clit, drawing ragged gasps of pleasure from her lips until you silence her with a kiss, driving your tongue into her mouth as your fingers assault her cunt, fingering her until she's nice and wet and ready.");
	
	outputText("\n\nYou shift forward ever so slightly, dragging your " + cockDescript(x) + " from " + flags[MILK_NAME] + "'s butt-cleavage and into the welcoming embrace of her womanhood.  You both moan with lust as your " + cockHead(x) + " presses into her, parting the folds of her cunny to feel the hot touch of her walls kissing your tip.  You slide into her with measured ease, " + cockDescript(x) + " spreading her walls wide as your hips move to meet, your groin pushing against her bubble butt, flesh yielding as you try and slide as much cockflesh into her eager channel as you can.");
	outputText("\n\nBy the time you've hilted " + flags[MILK_NAME] + " she's a mess, cunt drooling obscenely and tongue hanging from her mouth.  Her chest heaves in your hands as you fingers wrap back around her cherry-red nipples, her milk coming in erratic spurts as she undulates on your cock, hips and ass starting to bounce atop you.  You move to match her, hammering your [hips] home to meet her, thrusting your " + cockDescript(x) + " into her clinging depths.  " + flags[MILK_NAME] + " cups her hands to her breasts, pooling up handfuls of milk and splashing them onto your prick and her gash, nearly dousing the heat of your lust with the rush of cool cream; but another jack-hammer thrust shows her milk to be a magnificent lubricant, letting you slip and slide into her with ease.  Soon you're both moaning your lust, pleasured gasps and sighs echoing through the camp as you fuck " + flags[MILK_NAME] + "'s dripping cunt.");

	outputText("\n\nYou can feel your orgasm mounting, surging on as your " + cockDescript(x) + " hammers relentlessly into " + flags[MILK_NAME] + ".  With an animalistic roar, you push her down onto all fours and grab her ass for leverage.  She squeals when you push her down, but she recovers in an instant, wiggling her ass tantalizingly as your fingers sink into her pliant flesh.  With a vision full of that big, soft ass swaying as your dick pounds " + flags[MILK_NAME] + "'s, you can't help but cum.  You grint your teeth and give " + flags[MILK_NAME] + " a hard spank right on the ass, making her shriek with pleasure and pain, her cunt squeezing your " + cockDescript(x) + " at just the right moment: you shoot a load of white-hot seed straight into her womb, dick buried to the hilt inside her.  Around your spasming cock, " + flags[MILK_NAME] + "'s quim quivers and contracts, milking you for every drop; her teats let loose a wild stream of milk which pools around you, nearly hiding the excess spooge that pours from her battered cunny to stain the earth.");
	
	outputText("\n\nWhen your dick's finally depleted its load, you pull out with a contented sigh, wiping the last drops of spunk off on " + flags[MILK_NAME] + "'s thigh.  She rolls over, a lust-dazed smile on her face, idly fingering her well-stuffed cunt and caressing her ample bosoms.  A momentary come-hither look from her beckons you over, and " + flags[MILK_NAME] + " pulls you into her arms with a girlish giggle, resting you on your back and nuzzling her cheek on your [chest].  You drift off into pleasant repose, both sexually contented and your lover well-milked.");
...
function titFuckDatMilkSlut():void {
	clearOutput();
	outputText("You sit down beside " + flags[MILK_NAME] + " and give her a little push onto her back.  A tiny gasp escapes her lips, but is silenced as you move overtop her and giver her a long, tongue-filled kiss.  Her surprise turns into a lusty moan as you ");
	if(flags[MILK_SIZE] == 2) outputText("pull of her shift and bra");
	else outputText("sink your fingers into her utter-like teats");
	outputText(", caressing her sensitive breasts until a gentle stream of milk runs down her chest.  Her breath catches in anticipation as you back off a moment, freeing your [cock] from your [armor] and letting it flop onto her bare belly.  However, your hips slide forward away from her already-wet cunt and towards the enticing valley of her cleavage.  To your delight, the attention you're about to lavish on her breasts seems to excite " + flags[MILK_NAME] + " as much as a good fucking, and her breath picks up excitedly as your cock slips between her teats.  With a little urging, she cups her breasts and squeezes them together around your rock-hard member, enveloping it in the warm embrace of her dusky flesh.");
	
	outputText("\n\nBefore you can start to thrust into her chest, you reach down and pinch her nipples, rolling the two prominent peaks between your fingers, coaxing out a bigger and bigger flood of milk from her deep reserves.  White rivers run down from her mounds, a deluge flooding down into the valley around your [cock].  You shudder as the warm, thick cream pours in around your member.  " + flags[MILK_NAME] + " reaches in and rubs it into your cockflesh with slow, sensuous motions, gently stroking you off as more and more whiteness submerges your wang. Overcome by your lactic lust, you lean in and lap up the run-off from the lake of milk between " + flags[MILK_NAME] + "'s leaky breasts.  Your senses hum at the taste sweet cream tinted with lust, and as if on their own accord, your [hips] start to slide forward, your [cock] gliding between her tits like it would a well-lubed cunt.  " + flags[MILK_NAME] + " giggles at the sensation, squeezing her tits tightly together around your wang.");
	
	outputText("\n\nYou grab her shoulders for support and start to really get going.  Your hips move faster and faster, groin pounding into the undersides of " + flags[MILK_NAME] + "'s tits as you hammer into her milk-drenched cleavage.  She feels just as good as a warm, wet pussy around your cock, but with an added bonus: as the [cockHead] of your [cock] peaks out between the tops of her breasts, " + flags[MILK_NAME] + " leans her head up and wraps her full lips around it, her tongue flicking across the slit of your urethra and sending shivers of pleasure down your spine.  A low, husky moan escapes you as " + flags[MILK_NAME] + " sucks your cock at the crest of every thrust, putting all her suckling skill to work on your brim until your [cock] feels practically afire with pleasure.");
	
	outputText("\n\nCoaxed on by " + flags[MILK_NAME] + "'s oral ministrations, you abandon her breasts for a moment, ");
	//If not naga:
	if(!player.isNaga()) outputText("straddling her shoulders and shoving");
	else outputText("wrapping yourself around her to shove");
	outputText(" your [cock] deep into her mouth.  " + flags[MILK_NAME] + " accepts it eagerly, opening wide as you stuff inch after inch of your manhood down her throat.  Now she can really go to work: her lips wrap tight around your base, tongue lapping at your underside like candy as her throat muscles massage the shaft.  You slide in and out, watching her throat bulge and contract with each thrust");
	if(player.balls > 0) outputText(", shivering as her tongue darts out around your cock to flick your nads");
	outputText(".");

	outputText("\n\nJust as soon as you're settling into a rhythm, though, " + flags[MILK_NAME] + " surprises you with a sudden shift, rolling over onto all fours and taking your with her.  You flop onto your back, yelping in surprise as the busty maid tops you, her cheek resting in your thigh.  You start to protest, but are quickly silenced as her tongue wraps around the base of your cock, sliding up your fuckpole with languid ease.  You shudder and relax, content to let her put her tremendous oral proficiency to good use; and use it she does, soon getting onto all fours over your [cock], dragging her huge tits across the upright length until the sheer weight of her rack weighs your mighty penis down, pinning it to your belly.  Gently, she rocks her body forward, dragging her well-lubed tits up and down your length, only saving the [cockHead] for her mouth.  She leans down until you can feel every hot breath on your sensitive skin.  " + flags[MILK_NAME] + " takes her time, only slowly rolling her tongue around your crown, flicking her tip across your urethra and lapping up the pre that's now spurting liberally from your [cock].  You groan and clench your fists, trying to bear through the combination titfuck and blowjob, but you just can't withstand her ministrations.");

	outputText("\n\nWith one last surge of sexual energy, you wrap your [legs] around " + flags[MILK_NAME] + "'s shoulders and roll her over again, putting yourself back on top with cock held firmly between her hefty tits.  You jackhammer your [hips] into her underboobs, digging your fingers into her soft flesh and savaging her nipples until she's breathing hard and moaning, milk sloshing down into her cleavage again to perfectly lubricate your last thrusts until, with a feral roar, the first thick globs of your creamy spunk burst forth, mixing momentarily with the sea of milk around your [cock] before spattering onto " + flags[MILK_NAME] + "'s neck, giving her an instant pearl necklace.  Your cock spasms again and again, shooting jizz into the lake of milk until her breast-valley is a frothy admixture of cum and cream around your prick.  With a mischievous grin, your reach in and scoop up a double-handful of the solution you've made, and hold it up to " + flags[MILK_NAME] + "'s lips.  She smiles lustily up at you before suckling it all up, drinking every offered drop of sweet cream and seed.");
	
	outputText("\n\nYou sigh contentedly and give " + flags[MILK_NAME] + " an affectionate pat on the boob, watching as her flesh quivers at your touch.  She smiles at you with a lusty warmth, blowing you a kiss as you grab a towel to dry yourself off; you look back to see her happily masterbating, finishing the job you started with one hand knuckle-deep inside her as the other idly plays with the frothy cream you've left between her boobs.");
	stats(0,0,0,0,0,-1,-100,0);
	fatigue(-10);
	doNext(13);
